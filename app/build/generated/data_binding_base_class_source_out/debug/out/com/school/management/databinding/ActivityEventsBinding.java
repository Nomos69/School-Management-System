...
public final class ActivityEventsBinding implements ViewBinding {
  ...
  private ActivityEventsBinding(@NonNull CoordinatorLayout rootView,
      @NonNull AppBarLayout appBarLayout, @NonNull FloatingActionButton fabAddEvent,
  ...
  public static ActivityEventsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityEventsBinding((CoordinatorLayout) rootView, appBarLayout, fabAddEvent,
