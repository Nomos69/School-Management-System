...
public final class ActivityGradebookBinding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public static ActivityGradebookBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityGradebookBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_gradebook, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityGradebookBinding bind(@NonNull View rootView) {
